...
import DeleteItem from "../shared/buttons/DeleteItem";
...
export default function Card({ wikiPage }: CardProps) {
  ...
  return (
    <div className="rounded-lg border border-green-400  bg-green-300 p-2 hover:border-green-500">
